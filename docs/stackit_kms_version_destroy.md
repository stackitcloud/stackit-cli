...
```
stackit kms version destroy VERSION_NUMBER [flags]
```
...
```
  ...
  $ stackit kms version destroy 42 --key-id "my-key-id" --keyring-id "my-keyring-id"
```

### Options

```
  -h, --help                Help for "stackit kms version destroy"
