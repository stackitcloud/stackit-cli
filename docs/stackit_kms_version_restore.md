...
```
stackit kms version restore VERSION_NUMBER [flags]
```
...
```
  ...
  $ stackit kms version restore 42 --key-id "my-key-id" --keyring-id "my-keyring-id"
```

### Options

```
  -h, --help                Help for "stackit kms version restore"
