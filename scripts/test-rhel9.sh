...
# Test script for RHEL 9 RPM repository
# Uses test bucket for RPMs and GPG key

set -e

echo "=========================================="
echo "STACKIT CLI RHEL 9 RPM Test"
echo "=========================================="

# Configuration
CONTAINER_NAME="stackit-rhel9-test"
...
echo "Step 1: Starting RHEL 9 container..."
...
echo "=========================================="
echo "✅ RHEL 9 RPM test completed successfully!"
echo "==========================================" 