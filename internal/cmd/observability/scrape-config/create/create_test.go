...
var testPayload = &observability.CreateScrapeConfigPayload{
	...
	MetricsRelabelConfigs: &[]observability.CreateScrapeConfigPayloadMetricsRelabelConfigsInner{
		{
			Action:       utils.Ptr(observability.CREATESCRAPECONFIGPAYLOADMETRICSRELABELCONFIGSINNERACTION_REPLACE),
	...
	Scheme:         utils.Ptr(observability.CREATESCRAPECONFIGPAYLOADSCHEME_HTTPS),
