...
func TestParseInput(t *testing.T) {
	tests := []struct {
		...
		{
			description: "deleted record sets",
		...
		{
			description: "active record sets",
			flagValues: fixtureFlagValues(func(flagValues map[string]string) {
		...
		{
			description: "inactive record sets",
			flagValues: fixtureFlagValues(func(flagValues map[string]string) {
		...
		{
			description: "active and inactive record sets",
			flagValues: fixtureFlagValues(func(flagValues map[string]string) {
				flagValues[activeFlag] = "true"
				flagValues[inactiveFlag] = "true"
			}),
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		...
		model           *inputModel
		page            int
		expectedRequest dns.ApiListRecordSetsRequest
	}{
		{
			description:     "base",
...
func TestOutputResult(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := outputResult(params.Printer, tt.args.outputFormat, tt.args.zoneLabel, tt.args.recordSets); (err != nil) != tt.wantErr {
