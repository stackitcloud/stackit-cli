...
func fixtureRequest(mods ...func(request *albwaf.ApiDeleteCustomRuleGroupRequest)) albwaf.ApiDeleteCustomRuleGroupRequest {
	request := testClient.DefaultAPI.DeleteCustomRuleGroup(testCtx, testProjectId, testRegion, testCustomRgName)
	for _, mod := range mods {
		mod(&request)
	}
	return request
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description    string
		model          *inputModel
		expectedResult albwaf.ApiDeleteCustomRuleGroupRequest
	}{
		{
			description:    "base",
