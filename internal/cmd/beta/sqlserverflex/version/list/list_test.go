...
func fixtureRequest(mods ...func(request *sqlserverflex.ApiListVersionsRequest)) sqlserverflex.ApiListVersionsRequest {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest sqlserverflex.ApiListVersionsRequest
	}{
		{
			description:     "base",
