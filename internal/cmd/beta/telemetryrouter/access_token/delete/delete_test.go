...
func fixtureRequest(mods ...func(request *telemetryrouter.ApiDeleteAccessTokenRequest)) telemetryrouter.ApiDeleteAccessTokenRequest {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest telemetryrouter.ApiDeleteAccessTokenRequest
	}{
		{
			description:     "base",
