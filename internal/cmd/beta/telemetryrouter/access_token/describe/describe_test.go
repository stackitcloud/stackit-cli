...
func fixtureRequest(mods ...func(request *telemetryrouter.ApiGetAccessTokenRequest)) telemetryrouter.ApiGetAccessTokenRequest {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest telemetryrouter.ApiGetAccessTokenRequest
	}{
		{
			description:     "base",
...
func TestOutputResult(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "base",
			args: args{
				accessToken: new(telemetryrouter.GetAccessTokenResponse{
					Id:          uuid.NewString(),
					DisplayName: "Token",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := outputResult(params.Printer, tt.args.outputFormat, tt.args.accessToken); (err != nil) != tt.wantErr {
