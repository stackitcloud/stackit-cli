...
func fixtureRequest(mods ...func(request *telemetryrouter.ApiDeleteDestinationRequest)) telemetryrouter.ApiDeleteDestinationRequest {
	request := testClient.DefaultAPI.DeleteDestination(testCtx, testProjectId, testRegion, testInstanceId, testDestinationId)
	for _, mod := range mods {
		mod(&request)
	}
	return request
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest telemetryrouter.ApiDeleteDestinationRequest
	}{
		{
