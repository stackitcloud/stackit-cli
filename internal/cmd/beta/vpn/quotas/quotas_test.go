...
func fixtureRequest(mods ...func(request *vpn.ApiListQuotasRequest)) vpn.ApiListQuotasRequest {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest vpn.ApiListQuotasRequest
	}{
		{
			description:     "base",
...
func TestOutputResult(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := outputResult(params.Printer, tt.args.outputFormat, tt.args.quota, tt.args.projectLabel); (err != nil) != tt.wantErr {
