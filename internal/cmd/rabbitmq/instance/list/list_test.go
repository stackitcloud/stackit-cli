...
func fixtureRequest(mods ...func(request *rabbitmq.ApiListInstancesRequest)) rabbitmq.ApiListInstancesRequest {
	request := testClient.DefaultAPI.ListInstances(testCtx, testProjectId, testRegionId)
	for _, mod := range mods {
		mod(&request)
	}
	return request
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest rabbitmq.ApiListInstancesRequest
	}{
		{
			description:     "base",
