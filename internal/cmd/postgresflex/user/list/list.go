...
func NewCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List all PostgreSQL Flex users of an instance",
		Long:  "List all PostgreSQL Flex users of an instance.",
...
func outputResult(cmd *cobra.Command, outputFormat string, users []postgresflex.ListUsersResponseItem) error {
	switch outputFormat {
