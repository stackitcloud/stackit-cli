...
func fixtureRequest(mods ...func(request *ufw.ApiDeleteRuleRequest)) ufw.ApiDeleteRuleRequest {
	request := testClient.DefaultAPI.DeleteRule(testCtx, testProjectId, testRegion, testInstanceId)
	for _, mod := range mods {
		mod(&request)
	}
	return request
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest ufw.ApiDeleteRuleRequest
	}{
		{
			description:     "base",
