...
func fixtureTestFlavor() sqlserverflex.ListFlavors {
	return sqlserverflex.ListFlavors{
		Id:          testFlavorId,
		Cpu:         1,
		Memory:      4,
		Description: "SQLServer-Flex-1.4-Single-EU01",
		MaxGB:       4000,
		MinGB:       5,
		NodeType:    "Single",
...
func newApiMock(s mockSettings) sqlserverflex.DefaultAPI {
	return sqlserverflex.DefaultAPIServiceMock{
		ListFlavorsExecuteMock: utils.Ptr(func(_ sqlserverflex.ApiListFlavorsRequest) (*sqlserverflex.ListFlavorsResponse, error) {
			...
			return &sqlserverflex.ListFlavorsResponse{
				Flavors: s.flavors,
			}, nil
		}),
	}
