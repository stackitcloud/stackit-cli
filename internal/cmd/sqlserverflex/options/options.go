	...
	cmd := &cobra.Command{
		...
		Example: examples.Build(
			...
			examples.NewExample(
				...
				"$ stackit sqlserverflex options --user-roles --db-compatibilities --instance-id <INSTANCE_ID>"),
		),
		Deprecated: `command "stackit sqlserverflex options" is deprecated and will be removed after 2027-02-28. Please use "stackit sqlserverflex flavor list", "stackit sqlserverflex flavor describe", "stackit sqlserverflex version list", "stackit sqlserverflex instance user-role list", "stackit sqlserverflex instance db-collation list" and "stackit sqlserverflex instance db-compatibility list" instead.`,
