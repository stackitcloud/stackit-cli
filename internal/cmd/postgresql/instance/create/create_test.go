...
func fixtureRequest(mods ...func(request *postgresql.ApiCreateInstanceRequest)) postgresql.ApiCreateInstanceRequest {
	request := testClient.CreateInstance(testCtx, testProjectId)
	request = request.CreateInstancePayload(postgresql.CreateInstancePayload{
		InstanceName: utils.Ptr("example-name"),
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description       string
		model             *flagModel
		expectedRequest   postgresql.ApiCreateInstanceRequest
