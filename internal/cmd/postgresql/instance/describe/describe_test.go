...
func fixtureRequest(mods ...func(request *postgresql.ApiGetInstanceRequest)) postgresql.ApiGetInstanceRequest {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *flagModel
		expectedRequest postgresql.ApiGetInstanceRequest
	}{
		{
			description:     "base",
