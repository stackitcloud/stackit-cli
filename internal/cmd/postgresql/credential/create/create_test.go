...
func fixtureRequest(mods ...func(request *postgresql.ApiCreateCredentialsRequest)) postgresql.ApiCreateCredentialsRequest {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *flagModel
		expectedRequest postgresql.ApiCreateCredentialsRequest
	}{
		{
			description:     "base",
