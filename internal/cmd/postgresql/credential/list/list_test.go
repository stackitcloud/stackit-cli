...
func fixtureRequest(mods ...func(request *postgresql.ApiGetCredentialsIdsRequest)) postgresql.ApiGetCredentialsIdsRequest {
	request := testClient.GetCredentialsIds(testCtx, testProjectId, testInstanceId)
	for _, mod := range mods {
		mod(&request)
	}
	return request
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *flagModel
		expectedRequest postgresql.ApiGetCredentialsIdsRequest
	}{
		{
			description:     "base",
