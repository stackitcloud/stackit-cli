...
func fixtureRequest(mods ...func(request *valkey.ApiDeleteCredentialsRequest)) valkey.ApiDeleteCredentialsRequest {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest valkey.ApiDeleteCredentialsRequest
	}{
		{
			description:     "base",
