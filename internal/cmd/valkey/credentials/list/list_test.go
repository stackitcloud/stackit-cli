...
func fixtureRequest(mods ...func(request *valkey.ApiListCredentialsRequest)) valkey.ApiListCredentialsRequest {
...
func TestParseInput(t *testing.T) {
	tests := []struct {
		...
		{
			description: "limit invalid: zero",
			flagValues: fixtureFlagValues(func(flagValues map[string]string) {
		...
		{
			description: "limit invalid: negative",
			flagValues: fixtureFlagValues(func(flagValues map[string]string) {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest valkey.ApiListCredentialsRequest
	}{
		{
			description:     "base",
...
func TestOutputResult(t *testing.T) {
	type args struct {
		...
		credentials   []valkey.CredentialsListItem
	}
	tests := []struct {
		name    string
		args    args
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := outputResult(params.Printer, "", tt.args.instanceLabel, tt.args.credentials); (err != nil) != tt.wantErr {
