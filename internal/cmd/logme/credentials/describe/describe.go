...
func NewCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Shows details of credentials of an LogMe instance",
		Long:  "Shows details of credentials of an LogMe instance. The password will be shown in plain text in the output.",
