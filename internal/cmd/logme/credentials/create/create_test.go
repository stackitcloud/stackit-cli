...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest logme.ApiCreateCredentialsRequest
	}{
		{
			description:     "base",
	...
	for _, tt := range tests {
		t.Run(tt.description, func(t *testing.T) {
			...
			diff := cmp.Diff(request, tt.expectedRequest,
				...
				cmpopts.EquateComparable(testCtx, logme.DefaultAPIService{}),
			)
			if diff != "" {
...
func TestOutputResult(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := outputResult(params.Printer, tt.args.outputFormat, tt.args.showPassword, tt.args.instanceLabel, tt.args.credentials); (err != nil) != tt.wantErr {
