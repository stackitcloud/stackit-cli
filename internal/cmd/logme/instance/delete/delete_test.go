...
func fixtureRequest(mods ...func(request *logme.ApiDeleteInstanceRequest)) logme.ApiDeleteInstanceRequest {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest logme.ApiDeleteInstanceRequest
	}{
		{
			description:     "base",
	...
	for _, tt := range tests {
		t.Run(tt.description, func(t *testing.T) {
			...
			diff := cmp.Diff(request, tt.expectedRequest,
				...
				cmpopts.EquateComparable(testCtx, logme.ApiDeleteInstanceRequest{}),
			)
			if diff != "" {
