...
func fixtureRequest(mods ...func(request *logme.ApiGetInstanceRequest)) logme.ApiGetInstanceRequest {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest logme.ApiGetInstanceRequest
	}{
		{
			description:     "base",
	...
	for _, tt := range tests {
		t.Run(tt.description, func(t *testing.T) {
			...
			diff := cmp.Diff(request, tt.expectedRequest,
				...
				cmpopts.EquateComparable(testCtx, logme.ApiGetInstanceRequest{}),
			)
			if diff != "" {
