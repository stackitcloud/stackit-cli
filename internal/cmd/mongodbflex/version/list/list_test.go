...
func fixtureRequest(mods ...func(request *mongodbflex.ApiListVersionsRequest)) mongodbflex.ApiListVersionsRequest {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest mongodbflex.ApiListVersionsRequest
	}{
		{
			description:     "base",
