...
func fixtureRequestLogin() ske.ApiGetLoginKubeconfigRequest {
	return testClient.GetLoginKubeconfig(testCtx, testProjectId, testRegion, testClusterName)
}

func fixtureRequestIDP() ske.ApiGetIDPKubeconfigRequest {
	return testClient.GetIDPKubeconfig(testCtx, testProjectId, testRegion, testClusterName)
}
